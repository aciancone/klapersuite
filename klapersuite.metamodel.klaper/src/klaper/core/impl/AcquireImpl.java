 ...
 * <ul>
 *   <li>{@link klaper.core.impl.AcquireImpl#getResourceUnit <em>Resource Unit</em>}</li>
 *   <li>{@link klaper.core.impl.AcquireImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AcquireImpl extends ActivityImpl implements Acquire {
	...
	public void setResourceUnit(int newResourceUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ACQUIRE__RESOURCE_UNIT, oldResourceUnit, resourceUnit));
	}
	...
	public Resource getResource() {
		if (resource != null && resource.eIsProxy()) {
			...
			if (resource != oldResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.ACQUIRE__RESOURCE, oldResource, resource));
			}
		}
		return resource;
	}
	...
	public void setResource(Resource newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ACQUIRE__RESOURCE, oldResource, resource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CorePackage.ACQUIRE__RESOURCE:

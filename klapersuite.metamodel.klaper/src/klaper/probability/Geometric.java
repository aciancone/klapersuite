 ...
 * <ul>
 *   <li>{@link klaper.probability.Geometric#getMean <em>Mean</em>}</li>
 * </ul>
 * </p>
 *
 * @see klaper.probability.ProbabilityPackage#getGeometric()
 * @model
 * @generated
 */
public interface Geometric extends ProbabilityDistributionFunction {
	 ...
	 * @see klaper.probability.ProbabilityPackage#getGeometric_Mean()
	...
	/**
	 * Sets the value of the '{@link klaper.probability.Geometric#getMean <em>Mean</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

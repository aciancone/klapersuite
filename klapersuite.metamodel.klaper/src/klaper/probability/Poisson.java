 ...
 * <ul>
 *   <li>{@link klaper.probability.Poisson#getMean <em>Mean</em>}</li>
 * </ul>
 * </p>
 *
 * @see klaper.probability.ProbabilityPackage#getPoisson()
 * @model
 * @generated
 */
public interface Poisson extends ProbabilityDistributionFunction {
	 ...
	 * @see klaper.probability.ProbabilityPackage#getPoisson_Mean()
	...
	/**
	 * Sets the value of the '{@link klaper.probability.Poisson#getMean <em>Mean</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

...
public class ModuleItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsAutonomousPropertyDescriptor(object);
		}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DtmcPackage.Literals.MODULE__NODES);
			childrenFeatures.add(DtmcPackage.Literals.MODULE__TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DtmcPackage.Literals.MODULE__NODES,
				 DtmcFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(DtmcPackage.Literals.MODULE__TRANSITIONS,
				 DtmcFactory.eINSTANCE.createSynchronizedTransition()));

		newChildDescriptors.add
			(createChildParameter
				(DtmcPackage.Literals.MODULE__TRANSITIONS,
				 DtmcFactory.eINSTANCE.createCallTransition()));

		newChildDescriptors.add
			(createChildParameter
				(DtmcPackage.Literals.MODULE__TRANSITIONS,
				 DtmcFactory.eINSTANCE.createInvokedTransition()));

		newChildDescriptors.add
			(createChildParameter
				(DtmcPackage.Literals.MODULE__TRANSITIONS,
				 DtmcFactory.eINSTANCE.createStandardTransition()));
	}

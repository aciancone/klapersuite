 ...
 * <ul>
 *   <li>{@link simulator.distribution.impl.NormalImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link simulator.distribution.impl.NormalImpl#getVariance <em>Variance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NormalImpl extends ProbabilityDistributionFunctionImpl implements Normal {
	...
	protected EClass eStaticClass() {
		return DistributionPackage.Literals.NORMAL;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DistributionPackage.NORMAL__MEAN, oldMean, mean));
	}
	...
	public void setVariance(double newVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DistributionPackage.NORMAL__VARIANCE, oldVariance, variance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DistributionPackage.NORMAL__MEAN:
				return getMean();
			case DistributionPackage.NORMAL__VARIANCE:
				return getVariance();
		}

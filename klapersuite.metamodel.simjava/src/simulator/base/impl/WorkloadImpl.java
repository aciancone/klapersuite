 ...
 * <ul>
 *   <li>{@link simulator.base.impl.WorkloadImpl#getName <em>Name</em>}</li>
 *   <li>{@link simulator.base.impl.WorkloadImpl#getStep <em>Step</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkloadImpl extends EObjectImpl implements Workload {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.WORKLOAD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.WORKLOAD__NAME, oldName, name));
	}
	...
	public EList<Step> getStep() {
		if (step == null) {
			step = new EObjectContainmentEList<Step>(Step.class, this, BasePackage.WORKLOAD__STEP);
		}
		return step;
	}

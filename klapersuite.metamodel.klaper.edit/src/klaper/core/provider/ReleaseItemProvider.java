...
/**
 * This is the item provider adapter for a {@link klaper.core.Release} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Release_resourceUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Release_resourceUnit_feature", "_UI_Release_type"),
				 CorePackage.Literals.RELEASE__RESOURCE_UNIT,
				 true,
				 false,
				 false,
	...
	protected void addResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Release_resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Release_resource_feature", "_UI_Release_type"),
				 CorePackage.Literals.RELEASE__RESOURCE,
				 true,
				 false,
				 true,
				 null,

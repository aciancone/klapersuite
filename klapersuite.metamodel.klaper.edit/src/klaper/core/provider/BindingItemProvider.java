...
/**
 * This is the item provider adapter for a {@link klaper.core.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_call_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_call_feature", "_UI_Binding_type"),
				 CorePackage.Literals.BINDING__CALL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSignalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_signal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_signal_feature", "_UI_Binding_type"),
				 CorePackage.Literals.BINDING__SIGNAL,
				 true,
				 false,
				 true,
				 null,

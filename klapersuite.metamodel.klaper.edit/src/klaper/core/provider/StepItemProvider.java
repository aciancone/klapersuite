...
/**
 * This is the item provider adapter for a {@link klaper.core.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.STEP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_in_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_in_feature", "_UI_Step_type"),
				 CorePackage.Literals.STEP__IN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_out_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_out_feature", "_UI_Step_type"),
				 CorePackage.Literals.STEP__OUT,
				 true,
				 false,
				 true,
				 null,

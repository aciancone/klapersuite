...
/**
 * This is the item provider adapter for a {@link klaper.core.Workload} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkloadItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workload_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workload_type_feature", "_UI_Workload_type"),
				 CorePackage.Literals.WORKLOAD__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addPopulationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workload_population_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workload_population_feature", "_UI_Workload_type"),
				 CorePackage.Literals.WORKLOAD__POPULATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.WORKLOAD__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.WORKLOAD__BEHAVIOR);
			childrenFeatures.add(CorePackage.Literals.WORKLOAD__ARRIVAL_PROCESS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.WORKLOAD__BEHAVIOR,
				 CoreFactory.eINSTANCE.createBehavior()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.WORKLOAD__ARRIVAL_PROCESS,

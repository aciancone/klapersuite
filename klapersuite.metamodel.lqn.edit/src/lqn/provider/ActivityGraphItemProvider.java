...
/**
 * This is the item provider adapter for a {@link lqn.ActivityGraph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityGraphItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LqnPackage.Literals.ACTIVITY_GRAPH__PRECEDENCE);
			childrenFeatures.add(LqnPackage.Literals.ACTIVITY_GRAPH__ACTIVITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LqnPackage.Literals.ACTIVITY_GRAPH__PRECEDENCE,
				 LqnFactory.eINSTANCE.createPrecedence()));

		newChildDescriptors.add
			(createChildParameter
				(LqnPackage.Literals.ACTIVITY_GRAPH__ACTIVITY,
				 LqnFactory.eINSTANCE.createActivityDef()));
	}

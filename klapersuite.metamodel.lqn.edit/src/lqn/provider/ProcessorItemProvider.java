...
/**
 * This is the item provider adapter for a {@link lqn.Processor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LqnPackage.Literals.PROCESSOR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMultiplicityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_multiplicity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_multiplicity_feature", "_UI_Processor_type"),
				 LqnPackage.Literals.PROCESSOR__MULTIPLICITY,
				 true,
				 false,
				 false,
	...
	protected void addSpeedFactorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_speedFactor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_speedFactor_feature", "_UI_Processor_type"),
				 LqnPackage.Literals.PROCESSOR__SPEED_FACTOR,
				 true,
				 false,
				 false,
	...
	protected void addSchedulingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_scheduling_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_scheduling_feature", "_UI_Processor_type"),
				 LqnPackage.Literals.PROCESSOR__SCHEDULING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addReplicationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_replication_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_replication_feature", "_UI_Processor_type"),
				 LqnPackage.Literals.PROCESSOR__REPLICATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addQuantumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_quantum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_quantum_feature", "_UI_Processor_type"),
				 LqnPackage.Literals.PROCESSOR__QUANTUM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LqnPackage.Literals.PROCESSOR__TASK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LqnPackage.Literals.PROCESSOR__TASK,
				 LqnFactory.eINSTANCE.createTask()));
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Asynch Call</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link lqn.impl.AsynchCallImpl#getDest <em>Dest</em>}</li>
 *   <li>{@link lqn.impl.AsynchCallImpl#getFanin <em>Fanin</em>}</li>
 *   <li>{@link lqn.impl.AsynchCallImpl#getFanout <em>Fanout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AsynchCallImpl extends EObjectImpl implements AsynchCall {
	/**
	...
	protected EClass eStaticClass() {
		return LqnPackage.Literals.ASYNCH_CALL;
	}
	...
	public void setDest(String newDest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.ASYNCH_CALL__DEST, oldDest, dest));
	}
	...
	public void setFanin(int newFanin) {
		...
		fanin = newFanin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.ASYNCH_CALL__FANIN, oldFanin, fanin));
	}
	...
	public void setFanout(int newFanout) {
		...
		fanout = newFanout;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.ASYNCH_CALL__FANOUT, oldFanout, fanout));
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Making Call</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link lqn.impl.MakingCallImpl#getDest <em>Dest</em>}</li>
 *   <li>{@link lqn.impl.MakingCallImpl#getFanin <em>Fanin</em>}</li>
 *   <li>{@link lqn.impl.MakingCallImpl#getFanout <em>Fanout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MakingCallImpl extends EObjectImpl implements MakingCall {
	/**
	...
	protected EClass eStaticClass() {
		return LqnPackage.Literals.MAKING_CALL;
	}
	...
	public void setDest(String newDest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.MAKING_CALL__DEST, oldDest, dest));
	}
	...
	public void setFanin(int newFanin) {
		...
		fanin = newFanin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.MAKING_CALL__FANIN, oldFanin, fanin));
	}
	...
	public void setFanout(int newFanout) {
		...
		fanout = newFanout;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.MAKING_CALL__FANOUT, oldFanout, fanout));
	}

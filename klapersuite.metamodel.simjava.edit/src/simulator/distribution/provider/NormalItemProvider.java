...
/**
 * This is the item provider adapter for a {@link simulator.distribution.Normal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DistributionPackage.Literals.NORMAL__MEAN,
				 true,
				 false,
				 false,
	...
	protected void addVariancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Normal_variance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Normal_variance_feature", "_UI_Normal_type"),
				 DistributionPackage.Literals.NORMAL__VARIANCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,

...
/**
 * This is the item provider adapter for a {@link simulator.distribution.Exponential} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExponentialItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DistributionPackage.Literals.EXPONENTIAL__MEAN,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Exponential.class)) {
			case DistributionPackage.EXPONENTIAL__MEAN:

...
/**
 * This is the item provider adapter for a {@link simulator.base.Join} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JoinItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNTransitionPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the NTransition feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNTransitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Join_nTransition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Join_nTransition_feature", "_UI_Join_type"),
				 BasePackage.Literals.JOIN__NTRANSITION,
				 true,
				 false,
				 false,
	...
	protected void addInTransitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Join_inTransition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Join_inTransition_feature", "_UI_Join_type"),
				 BasePackage.Literals.JOIN__IN_TRANSITION,
				 true,
				 false,
				 true,
				 null,
